...
author: "Guillaume Pressiat || CHU Brest"
date: "`r Sys.Date()`"
...
Ce livret numérique présente des exemples de traitements de données PMSI avec R. L'objectif est de concentrer ici :
  ...
  - une documentation permettant de débuter avec l'import de données via le package [*pmeasyr*](https://github.com/GuillaumePressiat/pmeasyr)
