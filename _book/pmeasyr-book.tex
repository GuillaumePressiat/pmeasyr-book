...
=======
  \date{2017-06-18}
>>>>>>> e89f4e17d67ec0d267555d332201938dda3c85c7
>>>>>>> origin/master
...
Chaque utilisateur dispose de son path `\textasciitilde{}', qui équivaut
par exemple à : `/home/gui/'.

\subsection{Sous Windows}\label{sous-windows}

Chaque utilisateur dispose de son répertoire, exemple
\texttt{C:/Users/gui/}. Et souvent, sans l'utilisation de projets
RStudio, les chemins d'accès aux données sont pénibles à configurer dans
chaque programme.

Mais dans R, le symbole `\textasciitilde{}' utilisé sur windows dans un
chemin d'accès aux fichiers renvoie au répertoire Documents de
l'utilisateur : \texttt{C:/Users/gui/Documents}.
...
Par conséquent sur Windows le répertoire à créer pour localiser les
fichiers d'archives pmsi sera :
\texttt{C:/Users/gui/Documents/Documents/data}.

\textbf{N.B.: Nous proposons ici que les utilisateurs de
\texttt{pmeasyr} utilisent ce chemin générique pour leurs programmes.
L'avantage qui en découle : le partage de programme ne nécessite pas de
changer le chemin d'accès, puisque c'est le même.}
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/astat.html}{astat} &
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/irsa.html}{irsa} &
\textasciitilde{} MCO - Import des RSA\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/irum.html}{irum} &
\textasciitilde{} MCO - Import des RUM\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/idiap.html}{idiap} &
\textasciitilde{} MCO - Import des DIAP\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/idmi_mco.html}{idmi\_mco}
& \textasciitilde{} MCO - Import des DMI\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/iium.html}{iium} &
\textasciitilde{} MCO - Import des donnees UM\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/ileg_mco.html}{ileg\_mco}
& \textasciitilde{} MCO - Import des erreurs Leg\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/imed_mco.html}{imed\_mco}
& \textasciitilde{} MCO - Import des Med\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/ipo.html}{ipo} &
\textasciitilde{} MCO - Import des PO\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/iano_mco.html}{iano\_mco}
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/iano_had.html}{iano\_had}
& \textasciitilde{} HAD - Import des Anohosp\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/imed_had.html}{imed\_had}
& \textasciitilde{} HAD - Import des Med\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/irapss.html}{irapss} &
\textasciitilde{} HAD - Import des RAPSS\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/ileg_had.html}{ileg\_had}
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/iano_ssr.html}{iano\_ssr}
& \textasciitilde{} SSR - Import des Anohosp\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/irha.html}{irha} &
\textasciitilde{} SSR - Import des RHA\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/issrha.html}{issrha} &
\textasciitilde{} SSR - Import des SSRHA\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/imed_ssr.html}{imed\_ssr}
& \textasciitilde{} SSR - Import des MED\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/iium_ssr.html}{iium\_ssr}
& \textasciitilde{} SSR - Import des UM\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/ileg_ssr.html}{ileg\_ssr}
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/iano_psy.html}{iano\_psy}
& \textasciitilde{} PSY - Import des Anohosp\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/ir3a.html}{ir3a} &
\textasciitilde{} PSY - Import des R3A\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/irpsa.html}{irpsa} &
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/irafael.html}{irafael}
& \textasciitilde{} RSF - Import des RSFA / Rafael\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/iano_rafael.html}{iano\_rafael}
...
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{diags }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(diag }\OperatorTok{%in%}\StringTok{ }\NormalTok{liste_diag)}
\CommentTok{# position en das}
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{diags }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(diag }\OperatorTok{%in%}\StringTok{ }\NormalTok{liste_diag, position }\OperatorTok{==}\StringTok{ }\DecValTok{5}\NormalTok{)}
...
\CommentTok{# quelle que soit la position du diagnostic}
<<<<<<< HEAD
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{rsa }\OperatorTok{%>%}\StringTok{ }\KeywordTok{fiter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, dpdrum)}\OperatorTok{|}\KeywordTok{grepl}\NormalTok{(string_diags, das))}
\CommentTok{# position en das}
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{rsa }\OperatorTok{%>%}\StringTok{ }\KeywordTok{fiter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, das))}
\CommentTok{# position en dpdr}
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{rsa }\OperatorTok{%>%}\StringTok{ }\KeywordTok{fiter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, dpdrum))}
=======
\NormalTok{rsa15$rsa %>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, dpdrum)|}\KeywordTok{grepl}\NormalTok{(string_diags, das))}
\CommentTok{# position en das}
\NormalTok{rsa15$rsa %>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, das))}
\CommentTok{# position en dpdr}
\NormalTok{rsa15$rsa %>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(string_diags, dpdrum))}
>>>>>>> origin/master
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rsa15}\OperatorTok{$}\NormalTok{actes }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(CDCCAM }\OperatorTok{%in%}\StringTok{ }\NormalTok{liste_actes, ACT }\OperatorTok{==}\StringTok{ '1'}\NormalTok{) ->}\StringTok{ }\NormalTok{cob}
...
\midrule
\endhead
\href{https://im-aphp.github.io/pmeasyr/reference/itra.html}{itra} &
\textasciitilde{} TRA - Import du TRA\tabularnewline
\href{https://im-aphp.github.io/pmeasyr/reference/inner_tra.html}{inner\_tra}
...
\href{https://im-aphp.github.io/pmeasyr}{ici}.
...
\section{\texorpdfstring{Solution avec
\texttt{noyau\_pmeasyr()}}{Solution avec noyau\_pmeasyr()}}\label{solution-avec-noyau_pmeasyr}

\subsection{Définir le noyau de
paramètres}\label{definir-le-noyau-de-parametres}
